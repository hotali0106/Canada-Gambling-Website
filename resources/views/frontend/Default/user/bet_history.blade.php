            ...
            <div class="col-md-9 p-0">
                <div class="main-section px-4 py-4">
                    <div class="sub-menu mb-4">
                        <ul class="d-flex">
                            <li>
                                <a href="{{ route('frontend.profile.history.payment') }}" class="py-2 px-4">Payment History</a>
                            </li>
                            <li>
                                <a href="{{ route('frontend.profile.history.bet') }}" class="active py-2 px-4">Bets History</a>
                            </li>
                            <li>
                    ...
                    <div class="row my-2">
                        <div class="col-md-12">
                            You can show your betting history.
                        </div>
                    </div>  
