...
@section('content')
									...
									<div class="grid__content games">
										<div class="games__item">
											<div class="games__content">
												<img src="{{asset('frontend/Default/ico/'.$game->name.'.jpg')}}" alt="{{ $game->title }}">
			...
			<div class="footer__block">
				<div class="footer__left">
					...
					<a href="#" data-name="modal-bonus" class="gift" id="returns">
						<img src="{{asset('frontend/Default/img/_src/gift-active.png')}}" alt="" class="gift-icon active">
					</a>
					@endif
					<!--
					<a href="#" class="wheel">
				...
				<div class="footer__right">
					<a href="{{url('/logout')}}" class="footer__icon"><img src="{{asset('frontend/Default/img/_src/close.svg')}}" alt=""></a>
				</div>
			</div>
		</div>
	</footer>
	...
	<div class="modal modal-bonus" >
		...
		<span class="close-btn">
			<img src="{{asset('frontend/Default/img/_src/close.svg')}}" alt="">
		</span>
	</div>
