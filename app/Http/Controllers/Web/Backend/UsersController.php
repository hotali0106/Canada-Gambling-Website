...
/*            $checked = new \VanguardLTE\Lib\LicenseDK();
        ...
        public function create()
        {
            ...
            return view('backend.user.add', compact('roles', 'statuses', 'availibleUsers', 'happyhour'));
        }
        ...
        public function edit(\Illuminate\Http\Request $request, \VanguardLTE\Repositories\Activity\ActivityRepository $activitiesRepo, \VanguardLTE\User $user)
        {
            ...
            return view('backend.user.edit', compact('edit', 'user', 'roles', 'statuses', 'userActivities', 'hasActivities', 'langs', 'max_wins', 'max_bets', 'numbers'));
        }
