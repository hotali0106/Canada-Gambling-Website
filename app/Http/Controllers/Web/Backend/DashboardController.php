...
/*            $checked = new \VanguardLTE\Lib\LicenseDK();
            ...
            $open_shift = \VanguardLTE\OpenShift::select('open_shift.*')->orderBy('open_shift.start_date', 'DESC')->take(5)->get();
            ...
            return view('backend.dashboard.admin', compact('stats', 'latestRegistrations', 'usersPerMonth', 'user', 'statistics', 'gamestat', 'open_shift', 'summ', 'bank_stat'));
        }
