...
$response = ''; 
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D040B162710402D331E2209370C14231F2C252B172601 = $slotSettings->GetGameData('QueenOfHeartsDealerCard');
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('QueenOfHeartsDealerCard', $_obf_0D5B5C0F232838114030190505402A241E131019332901);
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $_obf_0D3B05322C2F210F0A1D1D0605210F04342A2F33143522 = [];
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        for( $row = 0; $row < 5; $row++ ) 
                        {
                            $_obf_0D0203142123271D3C3123163B23270C132D3825232832 = rand(1, 5);
                            if( $_obf_0D0203142123271D3C3123163B23270C132D3825232832 == 1 ) 
                            {
                                $_obf_0D0A382C25330D111A292F11105B331E1A330924092B22 = [
                                    0, 
                                    1, 
                                    2, 
                                    -1, 
                                ...
                                $_obf_0D283D290310072A081F3E5B5C3B321A5B0A190D080611 = [
                                    0, 
                                    1, 
                                    2
                                ];
                                shuffle($_obf_0D283D290310072A081F3E5B5C3B321A5B0A190D080611);
                                shuffle($_obf_0D0A382C25330D111A292F11105B331E1A330924092B22);
                                for( $_obf_0D1F1E22240A3B21241D1A231D28390A36160E34070A01 = 0; $_obf_0D1F1E22240A3B21241D1A231D28390A36160E34070A01 <= $_obf_0D0A382C25330D111A292F11105B331E1A330924092B22[0]; $_obf_0D1F1E22240A3B21241D1A231D28390A36160E34070A01++ ) 
                                {
                                    $_obf_0D2613221F3511102909331A5C2E1B1D085C3B05120332['reel' . ($row + 1)][$_obf_0D283D290310072A081F3E5B5C3B321A5B0A190D080611[$_obf_0D1F1E22240A3B21241D1A231D28390A36160E34070A01]] = $wild;
                                    $_obf_0D3B05322C2F210F0A1D1D0605210F04342A2F33143522[] = [
                                        $row, 
                                        $_obf_0D283D290310072A081F3E5B5C3B321A5B0A190D080611[$_obf_0D1F1E22240A3B21241D1A231D28390A36160E34070A01]
                                    ];
                                }
                            }
                        }
                    ...
                    for( $k = 0; $k < $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotLines']; $k++ ) 
                    {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            {
                                $s = [];
                                $s[0] = $_obf_0D2613221F3511102909331A5C2E1B1D085C3B05120332['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $_obf_0D2613221F3511102909331A5C2E1B1D085C3B05120332['reel2'][$linesId[$k][1] - 1];
                                $s[2] = $_obf_0D2613221F3511102909331A5C2E1B1D085C3B05120332['reel3'][$linesId[$k][2] - 1];
                                $s[3] = $_obf_0D2613221F3511102909331A5C2E1B1D085C3B05120332['reel4'][$linesId[$k][3] - 1];
                                $s[4] = $_obf_0D2613221F3511102909331A5C2E1B1D085C3B05120332['reel5'][$linesId[$k][4] - 1];
                                if( $s[0] == $wild ) 
                                {
                                    $mpl = 1;
                                    $_obf_0D365B172533170712222423300A1B092C161521071B32 = $slotSettings->Paytable[$wild][1] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] * $mpl * $bonusMpl;
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[3] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[3] == $wild) && ($s[4] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[4] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' && $slotSettings->GetGameData('QueenOfHeartsFreeGames') <= $slotSettings->GetGameData('QueenOfHeartsCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('QueenOfHeartsTotalWin') + $totalWin > 0 ) 
                {
                ...
                if( count($_obf_0D3B05322C2F210F0A1D1D0605210F04342A2F33143522) ) 
                {
                    $_obf_0D2B11213136401E3D35163C3440231F2F33015C070201 = '"flyObj":' . json_encode($_obf_0D3B05322C2F210F0A1D1D0605210F04342A2F33143522) . ',';
                }
                else
                {
                    $_obf_0D2B11213136401E3D35163C3440231F2F33015C070201 = '';
                }
                $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 = implode(',', $lineWins);
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotLines'] . ',"slotBet":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] . ',' . $_obf_0D2B11213136401E3D35163C3440231F2F33015C070201 . '"totalFreeGames":' . $slotSettings->GetGameData('QueenOfHeartsFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('QueenOfHeartsCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
