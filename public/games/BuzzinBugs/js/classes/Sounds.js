...
createjs.Sound.registerSound("/games/BuzzinBugs/source/SOUND/"+slotSettings.slotSounds[i], sId);	
...
addEventListener(SLOT_EVENT_AFTERSPINBONUSWHEEL,function(){createjs.Sound.stop();currentSound['FS_START']=PlaySound("FS_START");});
...
addEventListener(SLOT_EVENT_SPINBONUSWHEEL,function(){currentSound['WH']=PlaySound("WH", {loop:-1});});
