...
var SLOT_STATE_WAITBONUS2="WAITBONUS2";
...
var SLOT_EVENT_SPINBONUSWHEEL="SPINBONUSWHEEL";
var SLOT_EVENT_AFTERSPINBONUSWHEEL="AFTERSPINBONUSWHEEL";
...
dispatchEvent(new Event('COLLECT_SKIP'));	
   ...
   return;
	...
	}else if(slotState== SLOT_STATE_WAITBONUS2){
...
dispatchEvent(new Event(SLOT_EVENT_SPINBONUS));	
		...
		dispatchEvent(new Event(SLOT_EVENT_SPINBONUSWHEEL));
