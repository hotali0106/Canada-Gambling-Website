...
function BonusSpin(){
	...
	slotState=SLOT_STATE_SPIN;	
	dispatchEvent(new Event(SLOT_EVENT_STARTSPIN));		
	ServerConnect({slotEvent:"freespin",currentFreeMode:slotStateData.currentFreeMode,slotBet:slotStateData.betline,slotLines:slotStateData.lines});	
...
if((slotSpinResult.totalFreeGames>0 && slotSpinResult.currentFreeGames<slotSpinResult.totalFreeGames) || slotSpinResult.bonusInfo.scattersType=='bonus'){
gameUI.DisableButtons();
