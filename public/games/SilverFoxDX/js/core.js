...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/SilverFoxDX/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/SilverFoxDX/source/LOADER/progress'+i+'.png');
