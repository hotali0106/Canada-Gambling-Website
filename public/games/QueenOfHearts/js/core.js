...
var SLOT_EVENT_STARTFLY="STARTFLY";
var SLOT_EVENT_STOPFLY="STOPFLY";
var SLOT_EVENT_RESETSYM="SLOT_EVENT_RESETSYM";
...
addEventListener("reelStop",function(ev){
	...
	if(ev.detail.reel==slotSettings.slotReelsConfig.length){
		...
		if(slotSpinResult.flyObj!=undefined){
		
		dispatchEvent(new Event(SLOT_EVENT_STARTFLY));	
