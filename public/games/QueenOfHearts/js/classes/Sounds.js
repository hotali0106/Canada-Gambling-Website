...
createjs.Sound.registerSound("/games/QueenOfHearts/source/SOUND/"+slotSettings.slotSounds[i], sId);	
...
addEventListener(SLOT_EVENT_STARTFLY,function(){currentSound['ANGEL']=PlaySound("ANGEL", {loop:-1});});
addEventListener(SLOT_EVENT_STOPFLY,function(){currentSound['ANGEL'].paused=true;});
