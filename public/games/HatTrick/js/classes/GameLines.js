...
slotStateData.bonusAfterMpl=true;
self.ShowMultiplier();	
return;	
}else{		
slotStateData.bonusAfterMpl=false;	
self.StopWinLine();	
...
var winEvent=new CustomEvent(SLOT_EVENT_SHOWINMPL,{detail:{stepwin:slotSpinResult.freeMultiplier[3],currentWin:slotSpinResult.freeMultiplier[4]}});		
dispatchEvent(winEvent);	
...
if(slotStateData.bonusAfterMpl){
