...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/PharaonsGoldDX/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/PharaonsGoldDX/source/LOADER/progress'+i+'.png');
