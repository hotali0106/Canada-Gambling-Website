...
var randAnim=new Array(slotSpinResult.freeMultiplier[0]+"_1");	

slotStateData.currentMpl=randAnim[RandomInt(0,randAnim.length-1)];

	
currentSound[slotStateData.currentMpl]=PlaySound(slotStateData.currentMpl);	

delay=currentSound[slotStateData.currentMpl].duration;

	
var cprop=libArr['lnWinSym_'+slotStateData.currentMpl];	
...
winArr[3][slotSpinResult.freeMultiplier[1]].StopAnim();		
delete winArr[3][slotSpinResult.freeMultiplier[1]];	
slotState=SLOT_STATE_AFTERWIN;	
dispatchEvent(new Event(SLOT_EVENT_ENDWINLINE));
