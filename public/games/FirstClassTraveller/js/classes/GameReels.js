...
this.StopReel=function(rs,sym,rp){
...
if(sym == servSymbols[0] || sym == servSymbols[1] || sym == servSymbols[2]){
...
var chSym=ChangeSymFS(reelStrip[(rPos+i)]);		
...
var chSym=ChangeSymFS(servSymbols[i-1]);		
...
var chSym=ChangeSymFS(reelStrip[curPosition]);
...
var chSym=ChangeSymFS(servSymbols[rollCount-2]);	
...
objArr[i].StopReel(5+(i*5),slotSpinResult.reelsSymbols['reel'+(i+1)],slotSpinResult.reelsSymbols['rp'][i]);	
