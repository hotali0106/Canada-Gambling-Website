...
var SLOT_EVENT_STARTRESPIN="START_RESPIN";
...
var SLOT_EVENT_SHOWINMPL="SLOT_EVENT_SHOWINMPL";
var SLOT_EVENT_SOUNDMPL="SLOT_EVENT_SOUNDMPL";
/*
...
slotStateData.respinMode=false;
slotStateData.betline=slotSettings.Bet[slotSettings.BetCnt];	
slotStateData.bet=slotStateData.betline*slotStateData.lines;	
...
addEventListener("reelStop",function(ev){
	...
	if(ev.detail.reel==slotSettings.slotReelsConfig.length || slotStateData.respinMode){
...
addEventListener(SLOT_EVENT_AFTERSPIN,function(){
	...
	if(slotSpinResult.winLines.length>0 || slotSpinResult.bonusInfo.scattersType=="bonus"){
