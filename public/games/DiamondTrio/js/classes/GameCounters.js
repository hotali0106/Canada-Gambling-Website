...
this.ShowWinMpl=function(ev){

objArr['counterWinText'].text=slotLanguage['counterWin'];		
objArr['counterWinCnt'].text=NumFormat(ev.detail.stepwin);	
objArr['counterInfo2'].text=NumFormat(ev.detail.currentWin)+slotLanguage['counterInfo2Won'];	
...
addEventListener(SLOT_EVENT_SHOWINMPL,function(ev){self.ShowWinMpl(ev);});
	
addEventListener(SLOT_EVENT_EMPTYSPIN,function(ev){objArr['counterInfo1'].text=slotLanguage['counterInfo1GameOver'];objArr['counterInfo2'].text=" ";	objArr['counterInfo3'].text=" ";		});
...
addEventListener(SLOT_EVENT_STARTRESPIN,function(ev){objArr['counterInfo1'].text="";	objArr['counterInfo2'].text=slotLanguage['counterInfo2Respin'];});
