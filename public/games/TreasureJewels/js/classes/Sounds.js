...
createjs.Sound.registerSound("/games/TreasureJewels/source/SOUND/"+slotSettings.slotSounds[i], sId);	
...
return createjs.Sound.play(sid,setObj);
...
addEventListener(SLOT_EVENT_SHOWINMPLANIM,function(ev){currentSound['x2']=PlaySound("x2");});
addEventListener(SLOT_EVENT_SHOWINMPL,function(ev){currentSound['х2_MONEY']=PlaySound("х2_MONEY");});
