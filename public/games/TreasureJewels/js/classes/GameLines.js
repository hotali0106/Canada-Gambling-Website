...
function WinSpriteSymbol(jsonData,setObj,sName){
...
if(sName=="lnWinSym_P_1_X_1" || sName=="lnWinSym_P_1_X_3" || sName=="lnWinSym_P_1_X_7"){		
	
self.animData.animations={anim:[0,tFrames-1,"anim2",frm],anim2:[tFrames-9,tFrames-1,"anim2",frm]};		
...
libArr[objId]=new WinSpriteSymbol(cObj.config,cObj,objId);
