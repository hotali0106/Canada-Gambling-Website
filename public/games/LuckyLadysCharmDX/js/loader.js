...
for(prop in resObj){
	...
	loader.add('lnWinSym_FS',resObj[prop]['lnWinSym_FS'].config);	
	animationsRate['lnWinSym_FS']=	resObj[prop]['lnWinSym_FS'].framerate;
...
animationsArr['lnWinSym_FS']=resources['lnWinSym_FS'].data.frames;
...
mainSlotSet.open("GET", "/games/LuckyLadysCharmDX/config/desktop_view.json", true);
mainSlotSet.send();
