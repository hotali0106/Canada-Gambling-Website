...
this.ShowLady=function(){
var cprop=libArr['lnWinSym_LADY'];	
	console.log(cprop.GetAnimData());
	

	
objArr['Lady']=new PIXI.extras.AnimatedSprite(cprop.GetAnimData());	
objArr['Lady'].gotoAndPlay(0);			
objArr['Lady'].animationSpeed=(objectsSettings['head'].framerate/(CANVAS_FPS/100))/100;
objArr['Lady'].x=objectsSettings['head'].x;
objArr['Lady'].y=objectsSettings['head'].y;	
	
this._view.addChild(objArr['Lady']);	
...
self._view.removeChild(objArr['Lady']);	
self._view.addChild(objArr['Lady']);		
...
this._view.removeChild(objArr['Lady']);	
this._view.addChild(objArr['Lady']);		
