...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/LuckyLadysCharmDX/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/LuckyLadysCharmDX/source/LOADER/progress'+i+'.png');
