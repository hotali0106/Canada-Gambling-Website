...
mainSlotRes.open("POST", "/game/BookOfRa/server?sessionId="+sessionStorage.getItem('sessionId'), true);
...
function ChangeReelSymbol(sym){

	


	if(bonusMode && slotSpinResult.expSymbol==sym){
...
function ChangeReelSymbol2(sym){
