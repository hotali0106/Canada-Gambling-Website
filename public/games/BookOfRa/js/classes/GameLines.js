...
var cSym=slotSpinResult.expSymbol;		
	...
	winArr[slotStateData.rowCnt][slotStateData.cellCnt]=new WinSymbol(self._view,cprop.GetAnimData(),cSym,cprop.GetSprite());
    ...
    winArr[slotStateData.rowCnt][slotStateData.cellCnt].GetSprite().gotoAndStop(0);
...
if(slotSpinResult.expReels[jj]){
 winArr[jj][0].GetSprite().gotoAndPlay("anim");	
 winArr[jj][1].GetSprite().gotoAndPlay("anim");	
 winArr[jj][2].GetSprite().gotoAndPlay("anim");	
...
var cprop=libArr['lnWinSym_SCAT_INTRO'];	
...
},currentSound['SCAT_INTRO'].duration);		
