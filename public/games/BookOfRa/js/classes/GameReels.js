...
var chSym=ChangeReelSymbol(servSymbols[i-1]);	
	
var sAnim=setObj[chSym].res;	

objArr[i].gotoAndStop(""+sAnim[0]);	
}else{
	
	
var chSym=ChangeReelSymbol(reelStrip[curPosition]);	
...
var chSym=ChangeReelSymbol2(servSymbols[i-1]);	
...
var chSym=ChangeReelSymbol2(reelStrip[curPosition]);	
...
var chSym=ChangeReelSymbol(chSym1);		
...
var chSym=ChangeReelSymbol(servSymbols[rollCount-2]);	
...
addEventListener('RESET_REELS',function(){
	isFast=false;
	isResponse=false;
...
addEventListener(SLOT_EVENT_EXPREELS,function(){

	
objArr[0].FillServerReelBlack(slotSpinResult.reelsSymbols['reel1'],slotSpinResult.reelsSymbols['rp'][0]);	
objArr[1].FillServerReelBlack(slotSpinResult.reelsSymbols['reel2'],slotSpinResult.reelsSymbols['rp'][1]);	
objArr[2].FillServerReelBlack(slotSpinResult.reelsSymbols['reel3'],slotSpinResult.reelsSymbols['rp'][2]);	
objArr[3].FillServerReelBlack(slotSpinResult.reelsSymbols['reel4'],slotSpinResult.reelsSymbols['rp'][3]);		
objArr[4].FillServerReelBlack(slotSpinResult.reelsSymbols['reel5'],slotSpinResult.reelsSymbols['rp'][4]);
