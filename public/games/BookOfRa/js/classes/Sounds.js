...
createjs.Sound.registerSound("/games/BookOfRa/source/SOUND/"+slotSettings.slotSounds[i], sId);	
...
addEventListener('END_EXPWIN',function(ev){
	
currentSound['EXTRA_END']=PlaySound("EXTRA_END");		
});
addEventListener(SLOT_EVENT_EXPWINLINE,function(ev){
	
currentSound['EXTRA_LINE']=PlaySound("EXTRA_LINE");		
});
...
addEventListener(SLOT_EVENT_OPENBOOK,function(){currentSound['BOOK']=PlaySound("BOOK");});
addEventListener(SLOT_EVENT_BOOKTOHEADER,function(){currentSound['BOOK_HEADER']=PlaySound("BOOK_HEADER");});
addEventListener(SLOT_EVENT_BOOKSYM,function(){currentSound['BOOK_SYM']=PlaySound("BOOK_SYM");});
addEventListener(SLOT_EVENT_BOOKSYMADD,function(){currentSound['BOOK_SYM_ADD']=PlaySound("BOOK_SYM_ADD");});
...
if(bonusMode && currentSound['FS']!=undefined){
	...
	currentSound['SCAT_INTRO']=PlaySound("SCAT_INTRO");
