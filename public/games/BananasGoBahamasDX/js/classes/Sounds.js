...
createjs.Sound.registerSound("/games/BananasGoBahamasDX/source/SOUND/"+slotSettings.slotSounds[i], sId);	
...
currentSound['FS'].volume=0;	
	...
	switch(cSym){
		...
		currentSound['P_1_2']=PlaySound("P_1_2");	
		delayTime=currentSound['P_1_2'].duration;	
			
		}
		currentSound['P_1_FON']=PlaySound("P_1_FON");	
		break;
		...
		currentSound['P_2_FON']=PlaySound("P_2_FON");	
		break;	
		...
		currentSound['P_3_FON']=PlaySound("P_3_FON");	
		break;		
		...
		currentSound['P_5_3']=PlaySound("P_5_3");	
		delayTime=currentSound['P_5_3'].duration;	
			
		}
		currentSound['P_5_FON']=PlaySound("P_5_FON");	
		break;	
		...
		currentSound['P_6_3']=PlaySound("P_6_3");	
		delayTime=currentSound['P_6_3'].duration;	
			
		}
		currentSound['P_6_FON']=PlaySound("P_6_FON");	
		break;		
