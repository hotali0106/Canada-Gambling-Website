...
var canvas;
var stage;
var app = new PIXI.Application(CANVAS_W,CANVAS_H,{antialias:true,forceCanvas:true});
...
var SLOT_EVENT_OPENBOOK="SLOT_EVENT_OPENBOOK";
var SLOT_EVENT_BOOKTOHEADER="SLOT_EVENT_BOOKTOHEADER";
var SLOT_EVENT_BOOKSYMADD="SLOT_EVENT_BOOKSYMADD";
var SLOT_EVENT_BOOKSYM="SLOT_EVENT_BOOKSYM";
var SLOT_EVENT_EXPREELS="SLOT_EVENT_EXPREELS";
var SLOT_EVENT_EXPWINLINE="SLOT_EVENT_EXPWINLINE";
...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/BookOfRaCL/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/BookOfRaCL/source/LOADER/progress'+i+'.png');
...
switch(ev.detail.bname){
	...
	slotStateData.scatShow=false;
		dispatchEvent(new Event(SLOT_EVENT_OPENBOOK));
...
addEventListener(SLOT_EVENT_AFTERSPIN,function(){
	...
	}else if(slotSpinResult.currentFreeGames>=slotSpinResult.totalFreeGames){
