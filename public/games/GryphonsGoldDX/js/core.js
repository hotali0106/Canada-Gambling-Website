...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/GryphonsGoldDX/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/GryphonsGoldDX/source/LOADER/progress'+i+'.png');
