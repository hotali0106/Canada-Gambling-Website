...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/LuckyLadysCharmCL/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/LuckyLadysCharmCL/source/LOADER/progress'+i+'.png');
