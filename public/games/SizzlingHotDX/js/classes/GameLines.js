...
var cPos=parseInt(slotSpinResult.winLines[i]['winReel'+j][0]);	
	...
	if(sCount>3 && cSym2=="SCAT" && cSym=="SCAT"){
    cSym="SCAT_LONG";
	}	
	var cprop=libArr['lnWinSym_'+cSym];	
...
winArr[j][cPos].newSprite.name=j+"|"+cPos;
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_2_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_2_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_3_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_3_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_4_LONG_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_4_LONG_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	/*----------P_4---------------*/		
	/*----------P_5---------------*/	
	if(sCount>3 && cSym2=="P_6" && cSym3=="P_6"){
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_6_LONG_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_6_LONG_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_6_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_6_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
	...
	/*----------P_7---------------*/	
	if(sCount>3 && cSym2=="P_7" && cSym3=="P_7"){
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_7_LONG_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_7_LONG_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_7_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_7_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
	...
	/*----------P_5---------------*/	
	if(sCount>3 && cSym2=="P_5" && cSym3=="P_5"){
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_5_LONG_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_5_LONG_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_5_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_5_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
		...
		/*----------P_1---------------*/	
	if(sCount>3 && cSym2=="P_1" && cSym3=="P_1"){
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_P_1_LONG_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"P_1_LONG_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	/*----------P_1---------------*/
		...
		/*----------SCAT---------------*/	
	if(sCount>3 && cSym2=="SCAT" && cSym3=="SCAT"){
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_SCAT_LONG_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"SCAT_LONG_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
   ...
   winArr[j][cPos].newSprite.onComplete=function(ev){
	...
	var cprop2=libArr['lnWinSym_SCAT_LOOP'];	   
	self.SeqWinSym(self._view,cprop2.GetAnimData(),"SCAT_LOOP",parseInt(this.name.split("|")[0]),parseInt(this.name.split("|")[1]),this.parent);   
...
slotStateData.wTimeout=setTimeout(function(){
currentSound['COUNT']=PlaySound("COUNT");	
...
createjs.Sound.stop();		
var delayTime=1000;					  
var allWin=slotStateData.totalWin/slotStateData.bet;						  
	if(allWin<=5){
...
slotStateData.winlineInter2=setTimeout(function(){	
...
if(objArr['lnLine'+i+'f0']==undefined){
continue;	
}
...
console.log(objArr['lnBox'+i+'_0'],i);
...
clearTimeout(slotStateData.wTimeout);
createjs.Sound.stop();
isMainShow=false;
isMainScatters=false;	
...
clearTimeout(timeoutShow);
clearInterval(slotStateData.winlineInter);	
clearInterval(slotStateData.winlineInter2);	
slotState=SLOT_STATE_AFTERWIN;	
dispatchEvent(new Event(SLOT_EVENT_ENDWINLINE));		
currentWinLine=slotSpinResult.winLines.length+1;
self.ShowCurrentWinLine();
...
addEventListener(SLOT_EVENT_ENDWINLINE,function(){if(currentSound['COUNT']!=undefined){currentSound['COUNT'].paused=true;}});	
