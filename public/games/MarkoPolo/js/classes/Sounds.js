...
createjs.Sound.registerSound("/games/MarkoPolo/source/SOUND/"+slotSettings.slotSounds[i], sId);	
...
addEventListener(SLOT_EVENT_SHOWINMPL,function(ev){currentSound['x2_MONEY']=PlaySound("x2_MONEY");});
