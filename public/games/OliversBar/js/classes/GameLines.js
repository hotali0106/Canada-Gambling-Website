...
this.ShowFullReels=function(){
	
var rPos=gameReels.GetPositions();		
	
for(var i=1;i<=5;i++){
	
if(slotSpinResult.isFullReel[i-1]){

/*-----------*/
var cPos=0;
if(winArr[i][cPos]==undefined ){	
	
var cprop=libArr['lnWinSym_P_1_1'];	
winArr[i][cPos]=new WinSymbol(this._view,cprop.GetAnimData(),'P_1_1',cprop.GetSprite());
winArr[i][cPos].StartAnim({x:rPos[i-1].x,y:rPos[i-1].y+(symHeight*cPos)});
...
var cprop=libArr['lnWinSym_P_1_2'];	
winArr[i][cPos]=new WinSymbol(this._view,cprop.GetAnimData(),'P_1_1',cprop.GetSprite());
winArr[i][cPos].StartAnim({x:rPos[i-1].x,y:rPos[i-1].y+(symHeight*cPos)});
...
var cprop=libArr['lnWinSym_P_1_3'];	
winArr[i][cPos]=new WinSymbol(this._view,cprop.GetAnimData(),'P_1_1',cprop.GetSprite());
winArr[i][cPos].StartAnim({x:rPos[i-1].x,y:rPos[i-1].y+(symHeight*cPos)});
